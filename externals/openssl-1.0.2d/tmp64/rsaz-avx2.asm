...
DB	0xc5,0x78,0x29,0x78,0x70
	lea	r11,[$L$gather_table]
	mov	eax,r8d
	and	r8d,3
	shr	eax,2
	shl	r8d,4

	vmovdqu	ymm7,YMMWORD[((-32))+r11]
	vpbroadcastb	xmm8,BYTE[8+rax*1+r11]
	vpbroadcastb	xmm9,BYTE[7+rax*1+r11]
	vpbroadcastb	xmm10,BYTE[6+rax*1+r11]
	vpbroadcastb	xmm11,BYTE[5+rax*1+r11]
	vpbroadcastb	xmm12,BYTE[4+rax*1+r11]
	vpbroadcastb	xmm13,BYTE[3+rax*1+r11]
	vpbroadcastb	xmm14,BYTE[2+rax*1+r11]
	vpbroadcastb	xmm15,BYTE[1+rax*1+r11]

	lea	rdx,[64+r8*1+rdx]
	mov	r11,64
	mov	eax,9
	jmp	NEAR $L$oop_gather_1024

ALIGN	32
$L$oop_gather_1024:
	vpand	xmm0,xmm8,XMMWORD[((-64))+rdx]
	vpand	xmm1,xmm9,XMMWORD[rdx]
	vpand	xmm2,xmm10,XMMWORD[64+rdx]
	vpand	xmm3,xmm11,XMMWORD[r11*2+rdx]
	vpor	xmm1,xmm1,xmm0
	vpand	xmm4,xmm12,XMMWORD[64+r11*2+rdx]
	vpor	xmm3,xmm3,xmm2
	vpand	xmm5,xmm13,XMMWORD[r11*4+rdx]
	vpor	xmm3,xmm3,xmm1
	vpand	xmm6,xmm14,XMMWORD[64+r11*4+rdx]
	vpor	xmm5,xmm5,xmm4
	vpand	xmm2,xmm15,XMMWORD[((-128))+r11*8+rdx]
	lea	rdx,[r11*8+rdx]
	vpor	xmm5,xmm5,xmm3
	vpor	xmm6,xmm6,xmm2
	vpor	xmm6,xmm6,xmm5
	vpermd	ymm6,ymm7,ymm6
	vmovdqu	YMMWORD[rcx],ymm6
	lea	rcx,[32+rcx]
	dec	eax
...
$L$gather_permd:
	DD	0,7,1,7,2,7,3,7
$L$gather_table:
DB	0,0,0,0,0,0,0,0,0xff,0,0,0,0,0,0,0
ALIGN	64
