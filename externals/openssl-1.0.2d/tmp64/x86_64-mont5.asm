...
ALIGN	32
mulx4x_internal:
DB	0x4c,0x89,0x8c,0x24,0x08,0x00,0x00,0x00
DB	0x67
	neg	r9
	shl	r9,5
	lea	r13,[256+r9*1+rdx]
	...
	movq	xmm0,QWORD[((-96))+rdi]
	lea	rbx,[256+rdi]
	movq	xmm1,QWORD[((-32))+rdi]
	pand	xmm0,xmm4
	movq	xmm2,QWORD[32+rdi]
	pand	xmm1,xmm5
	movq	xmm3,QWORD[96+rdi]
	pand	xmm2,xmm6
	por	xmm0,xmm1
	movq	xmm1,QWORD[((-96))+rbx]
	pand	xmm3,xmm7
	por	xmm0,xmm2
	movq	xmm2,QWORD[((-32))+rbx]
	por	xmm0,xmm3
DB	0x67,0x67
	pand	xmm1,xmm4
	movq	xmm3,QWORD[32+rbx]

DB	102,72,15,126,194
	movq	xmm0,QWORD[96+rbx]
	lea	rdi,[512+rdi]
	pand	xmm2,xmm5
DB	0x67,0x67
	pand	xmm3,xmm6
...
DB	0x48,0x8d,0xb6,0x20,0x00,0x00,0x00
	adcx	r13,rax
	adcx	r14,rbp
	...
	adcx	r15,rax
	adox	r10,r11
	mulx	r11,rax,QWORD[16+rcx]
	adcx	r10,rax
	adox	r11,r12
	mulx	r12,rax,QWORD[32+rcx]
	mov	rdi,QWORD[((24+8))+rsp]
DB	0x66
	mov	QWORD[((-32))+rbx],r10
	adcx	r11,rax
	adox	r12,r13
	mulx	r15,rax,QWORD[48+rcx]
DB	0x67,0x67
	mov	rdx,r9
	mov	QWORD[((-24))+rbx],r11
	adcx	r12,rax
	adox	r15,rbp
DB	0x48,0x8d,0x89,0x40,0x00,0x00,0x00
...
$L$sqrx8x_reduce:
	...
	mulx	r9,rbx,QWORD[16+rbp]
	adcx	r8,rbx
	adox	r9,r10

	mulx	r10,rbx,QWORD[32+rbp]
	adcx	r9,rbx
	adox	r10,r11

	mulx	r11,rbx,QWORD[48+rbp]
	adcx	r10,rbx
	adox	r11,r12

DB	0xc4,0x62,0xe3,0xf6,0xa5,0x40,0x00,0x00,0x00
	mov	rax,rdx
	mov	rdx,r8
	adcx	r11,rbx
	adox	r12,r13
	...
	mulx	r13,rax,QWORD[80+rbp]
	adcx	r12,rax
	adox	r13,r14

	mulx	r14,rax,QWORD[96+rbp]
	adcx	r13,rax
	adox	r14,r15

	mulx	r15,rax,QWORD[112+rbp]
	mov	rdx,rbx
	adcx	r14,rax
	adox	r15,rsi
	adcx	r15,rsi
...
$L$sqrx8x_tail:
	...
	mulx	r9,rax,QWORD[16+rbp]
	adcx	r8,rax
	adox	r9,r10

	mulx	r10,rax,QWORD[32+rbp]
	adcx	r9,rax
	adox	r10,r11

	mulx	r11,rax,QWORD[48+rbp]
	adcx	r10,rax
	adox	r11,r12

DB	0xc4,0x62,0xfb,0xf6,0xa5,0x40,0x00,0x00,0x00
	adcx	r11,rax
	adox	r12,r13
