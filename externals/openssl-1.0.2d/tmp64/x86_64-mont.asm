...
$L$mulx4x_inner:
	...
	pxor	xmm0,xmm0
	mov	r8,QWORD[rax*1+rcx]
	mov	r9,QWORD[8+rax*1+rcx]
	neg	r8
	jmp	NEAR $L$mulx4x_sub_entry
...
$L$mulx4x_sub:
	...
	not	r8
$L$mulx4x_sub_entry:
	mov	r10,QWORD[16+rax*1+rcx]
	not	r9
	and	r8,r15
	mov	r11,QWORD[24+rax*1+rcx]
	not	r10
	and	r9,r15
	not	r11
	and	r10,r15
	...
	adc	r10,QWORD[16+rbx]
	adc	r11,QWORD[24+rbx]
